        ...
        >
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full px-3 py-2 border border-gray-200 rounded-full focus:outline-none focus:ring-1 focus:ring-green-500 text-sm"
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2 bg-green-500 text-white text-sm rounded-full disabled:opacity-50"
              >
                Join Chat
              </button>
              <button
        ...
        <div className="px-3 py-2">
          ...
          <div className="flex space-x-1 mt-2">
            ...
            {localActiveUsers.map((username) => (
              <div key={username} className="flex items-center space-x-1 bg-gray-600 rounded-full px-2 py-1">
          ...
          {messages.map((message) => (
            <div key={message.id} className="flex space-x-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className={`text-sm p-2 rounded-3xl ${
                  message.isAI 
        ...
        <div className="p-3">
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-400 rounded-full text-sm focus:outline-none focus:ring-1 focus:ring-green-500 bg-gray-700 text-white placeholder-gray-300"
              maxLength={500}
            />
            <button
              onClick={sendMessage}
              disabled={!input.trim()}
              className="px-3 py-2 bg-green-500 text-white rounded-full text-sm disabled:opacity-50"
            >
              →
            </button>
          </div>

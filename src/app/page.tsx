                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (!result.success && result.error) {
                      ...
                      if (result.error.includes('Google OAuth is not enabled')) {
                        setShowGoogleAuth(false); // Hide the button
                        setError('Google sign-in is currently unavailable. Please use email/password authentication.');
                      } else {
                        setError(result.error);
                      }
                    }
